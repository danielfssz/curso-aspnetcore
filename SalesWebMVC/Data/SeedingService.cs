...
namespace SalesWebMVC.Data
{
    ...
    {
        //Registra a dependencia com o dbContext
        ...
        public void Seed()
        {
            //Verifica se o banco de dados tem alguma coisa nessas tabelas usando o Linq Any
            ...
            Department d1 = new Department(1, "Mecanica");
            Department d2 = new Department(2, "Eletronica");
            Department d3 = new Department { Id = 3, Name = "Quimica" };
            Department d4 = new Department { Id = 4, Name = "Computação" };

            Seller s1 = new Seller(1, "Daniel Souza","daniel@gmail.com", new DateTime(1998,01,28), 1000.0, d1);
            Seller s2 = new Seller(2, "Danilo Souza", "danilo@gmail.com", new DateTime(2002, 04, 15), 800.50, d2);
            Seller s3 = new Seller(3, "Gabriela Souza", "gabriela@gmail.com", new DateTime(2000, 02, 26), 987.66, d3);
            Seller s4 = new Seller(4, "Sonia Souza", "sonia@gmail.com", new DateTime(1963, 02, 02), 1205.26, d4);
            ...
            SalesRecord r20 = new SalesRecord(20, new DateTime(2018, 10, 15), 8000.0, SaleStatus.Billed, s4);
            ...
            SalesRecord r24 = new SalesRecord(24, new DateTime(2018, 10, 12), 8000.0, SaleStatus.Billed, s1);
            ...
            // Adiciona os Department ao contexto
            _context.Department.AddRange(d1, d2, d3, d4);

            // Adiciona os Seller ao contexto
            _context.Seller.AddRange(s1, s2, s3, s4);

            // Adiciona os SalesRecord ao contexto
